...
func init() {
    core.RegisterJSONTypeDecoder("http.Version", &VersionStringCodec{})
    core.RegisterJSONTypeEncoder("http.Version", &VersionStringCodec{})
}
...
func (codec *VersionStructCodec) IsEmpty(ptr unsafe.Pointer) bool {
    version := codec.bareVersion(ptr)
    return version == nil || version.Major == 0
}
